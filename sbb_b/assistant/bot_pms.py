...
async def bot_start(event):
    ...
    if chat.id != Config.OWNER_ID:
        ...
        buttons = [
            (
                Button.url("تنصيب ستوك ثون❤️", "https://t.me/stockthon"),
                Button.url(
                    "مساعدة ❓",
                    "https://t.me/B99B2",
                ),
        ...
        buttons = [
            [
                Button.url("• السورس •", "https://t.me/stockthon"),
            ],
            [
