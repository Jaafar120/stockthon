...
async def update(event, repo, ups_rem, ac_br):
    ...
    await event.edit(
        "𓆰 𝚂𝙾𝚄𝚁𝙲𝙴 𝚂𝚃𝙾𝙲𝙺𝚃𝙷𝙾𝙽 - 𝑼𝑷𝑫𝑨𝑻𝑬 𝑴𝑺𝑮 𓆪\n𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻\n**⪼ تم التحديث بنجاح ✅**\n ** جارٍ إعادة تشغيلبوت ستوك ثون ، انتظر 𓆰.**"
    )
...
async def upstream(event):
    "بالنسبة لأمر التحديث ، تحقق مما إذا كانبوت ستوك ثون محدثًا ، أو قم بالتحديث إذا تم بتحديثه"
    ...
    if HEROKU_API_KEY is None or HEROKU_APP_NAME is None:
        return await edit_or_reply(
            event,
            "𓆰 𝚂𝙾𝚄𝚁𝙲𝙴 𝚂𝚃𝙾𝙲𝙺𝚃𝙷𝙾𝙽  - 𝑼𝑷𝑫𝑨𝑻𝑬 𝑴𝑺𝑮 𓆪\n 𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻\n** ⪼ اضبط المتغيرات المطلوبة أولاً لتحديث البوت  ستوك ثون 𓆰،**",
        )
    try:
    ...
    if conf == "الان":
        await event.edit(
            "𓆰 𝚂𝙾𝚄𝚁𝙲𝙴 𝚂𝚃𝙾𝙲𝙺𝚃𝙷𝙾𝙽  - 𝑼𝑷𝑫𝑨𝑻𝑬 𝑴𝑺𝑮 𓆪\n 𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻\n**⪼ يتم تحديث البوت  ستوك ثون انتظر 🌐..𓆰،**"
        )
