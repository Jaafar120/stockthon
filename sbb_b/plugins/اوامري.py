...
ROE = "** هـذه هي قائمة اوامـر سـورس ستوك ثون **"
...
if Config.TG_BOT_USERNAME is not None and tgbot is not None:
    ...
    async def inline_handler(event):
        ...
        if query.startswith("اوامري") and event.query.user_id == sbb_b.uid:
            buttons = [
                [Button.inline("معلومات ستوك ثون", data="AOMRDB")],
                [
...
اوامر فارات سورس ستوك ثون @stockthon""",
        buttons=[
...
* يمكنك الحصول على  كليشة جاهزة من هذه القناة @stockthon
ملاحظة : يمكنك استخدام الاوامر في اي دردشة او محادثة
اوامر فارات سورس ستوك ثون @stockthon""",
        buttons=[
            [Button.inline("رجوع", data="pmvars")],
