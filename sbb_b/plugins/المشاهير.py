# arthon بعد
# Copyright (C) 2022 stockthon. All Rights Reserved
#
# This file is a part of < https://github.com/arthonee/tt_1/ >
# PLease read the GNU Affero General Public License in
# <https://www.github.com/Jaafar120/Stockthon/blob/master/LICENSE/>.
#arthon
...
FANAN = "<b> 𓆩 sᴛᴏᴄᴋᴛʜᴏɴ ɪs ᴡᴏʀᴋɪɴɢ❛ - 💞🤵💞 𓆪 </b>"
VANAN = "<b>✾╎افيشش 🥺💘 </b>"
...
async def zfetch_info(replied_user, event):
    ...
    if x == 1:
       ...
       caption += f"\n\n<b> 𓆩 sᴛᴏᴄᴋᴛʜᴏɴ ɪs ᴡᴏʀᴋɪɴɢ❛ 𓆪 </b> - @stockthon "
...
async def ifetch_info(replied_user, event):
    ...
    if x == 9:
       ...
       caption += f"\n\n<b> 𓆩 sᴛᴏᴄᴋᴛʜᴏɴ ɪs ᴡᴏʀᴋɪɴɢ❛ ?? </b> - @stockthon "
